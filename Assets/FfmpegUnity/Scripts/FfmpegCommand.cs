...
namespace FfmpegUnity
{
    public class FfmpegCommand : MonoBehaviour
    {
        ...
        public bool IsFinished
        {
            get
            {
                return isFinished_ || !IsRunning && IsAlreadyStart;
            }
            private set
            {
                isFinished_ = value;
        ...
        {
            if (stopFfmpegExecuteFlag_ && IsAlreadyStart && CommandImp != null && CommandImp.IsRunning)
            {
                StopFfmpegMain();
        ...
        public static IEnumerator SetFontFiles(string[] files)
        {
            ...
            yield return FfmpegCommandImpAndroid.SetFontFiles(files);
#endif
            yield break;
        }
